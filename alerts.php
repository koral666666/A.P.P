...
<body id="alerts" class="alerts_class">
    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-auto"><a href="abnormality_alerts.php"><svg></svg><span>Abnormality</span></a></div>
                <div class="col-auto"><a href="#"><svg></svg><span>Colling Units</span></a></div>
                <div class="col-auto"><a href="#"><svg></svg><span>System</span></a></div>
            </div>
        </div>
    </main>
